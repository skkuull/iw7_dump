...
f0_local0 = function ( f1_arg0, f1_arg1 )
	local f1_local0 = Prestige.GetPermanentUnlockTokenCount( f1_arg1 )
	...
	if f1_local1 then
		...
		if not f1_local4 then
			...
			if f1_local1 then
				f1_arg0.PermanentUnlockTokenInfo:setText( Engine.Localize( "PRESTIGE_PERMANENT_UNLOCKED_TOKENS_AVAILABLE", f1_local0 ), 0 )
			else
				f1_arg0.PermanentUnlockTokenInfo:setText( Engine.Localize( "PRESTIGE_PERMANENT_UNLOCKED_TOKENS_REQUIRED" ), 0 )
			end
		end
	end
	f1_local4 = 1
...
f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	f2_arg0:addEventHandler( "button_action", function ( f3_arg0, f3_arg1 )
		ACTIONS.OpenMenu( "PermanentUnlocksMenu", true, f2_arg1 )
	end )
...
function HeadquartersPermanentUnlockStoreButton( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 500 * _1080p, 0, 195 * _1080p )
	self.id = "HeadquartersPermanentUnlockStoreButton"
	self._animationSets = {}
	self._sequences = {}
	...
	PermanentUnlockTokenIcon:setImage( RegisterMaterial( "icon_prestige_unlocktoken" ), 0 )
	PermanentUnlockTokenIcon:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 54, _1080p * 204, _1080p * 36, _1080p * 186 )
	...
	PermanentUnlockTokenInfo:setText( Engine.Localize( "PRESTIGE_PERMANENT_UNLOCKED_TOKENS_REQUIRED" ), 0 )
	...
	PermanentUnlockTokenInfo:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 232, _1080p * 492, _1080p * 111, _1080p * 137 )
	...
	LockedIcon:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 330, _1080p * 394, _1080p * 30, _1080p * 94 )
	...
	GenericButtonSelection:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 500, _1080p * 24, _1080p * 195 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		PermanentUnlockTokenInfo:RegisterAnimationSequence( "Locked", {
			{
				function ()
					return self.PermanentUnlockTokenInfo:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 228, _1080p * 488, _1080p * 111, _1080p * 137, 0 )
				end
			}
		} )
		...
		PermanentUnlockTokenInfo:RegisterAnimationSequence( "Unlocked", {
			{
				function ()
					return self.PermanentUnlockTokenInfo:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 228, _1080p * 488, _1080p * 116, _1080p * 142, 0 )
				end
			}
		} )
...
MenuBuilder.registerType( "HeadquartersPermanentUnlockStoreButton", HeadquartersPermanentUnlockStoreButton )
LockTable( _M )
