...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	f1_arg0:registerEventHandler( "button_down", function ( element, event )
		OSK.OpenScreenKeyboard( f1_arg1, Engine.Localize( "MP_EMBLEM_EDITOR_ENTER_NAME" ), element.Text:getText(), 16, false, true, false, function ( f3_arg0, f3_arg1 )
			if f3_arg1 ~= nil and f3_arg1 ~= "" then
				element.Text:setText( f3_arg1 )
				element:dispatchEventToParent( {
					name = "emblemName_updated",
					immediate = true
				} )
			end
...
function EmblemNameTextBox( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 734 * _1080p, 0, 50 * _1080p )
	self.id = "EmblemNameTextBox"
	...
	ButtonSelection:SetAnchorsAndPosition( 0, 0, 0, 0, 0, 0, 0, 0 )
	...
	Text:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 12, 0, _1080p * 2.5, _1080p * 47.5 )
...
MenuBuilder.registerType( "EmblemNameTextBox", EmblemNameTextBox )
LockTable( _M )
