...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	f1_arg0.LoadoutSettingsList.Details = f1_arg0.SettingDetails
	f1_arg0.MenuTitle.MenuBreadcrumbs:setText( CoD.GetBreadcrumb(), 0 )
end

function CodcasterLoadoutSettings( menu, controller )
	local self = LUI.UIVerticalNavigator.new()
	self.id = "CodcasterLoadoutSettings"
	...
	MenuTitle.MenuTitle:setText( ToUpperCase( Engine.Localize( "CODCASTER_LOADOUT_SETTINGS" ) ), 0 )
	...
	local LoadoutSettingsList = nil
	
	LoadoutSettingsList = MenuBuilder.BuildRegisteredType( "CodCasterLoadoutSettingList", {
		controllerIndex = f3_local1
	} )
	LoadoutSettingsList.id = "LoadoutSettingsList"
	LoadoutSettingsList:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 104, _1080p * 875, _1080p * 219, _1080p * 1180 )
	self:addElement( LoadoutSettingsList )
	self.LoadoutSettingsList = LoadoutSettingsList
	...
	ButtonDescription:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 130, _1080p * 550, _1080p * 539, _1080p * 571 )
...
MenuBuilder.registerType( "CodcasterLoadoutSettings", CodcasterLoadoutSettings )
LockTable( _M )
