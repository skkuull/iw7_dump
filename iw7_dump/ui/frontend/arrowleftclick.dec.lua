...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	f1_arg0:addEventHandler( "button_action", function ()
		local f4_local0 = "MovedLeft"
		local f4_local1 = "button_shoulderl"
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		Image:RegisterAnimationSequence( "NotBlocked", {
			...
			},
			{
				...
				function ()
					return self.Image:SetAnchorsAndPosition( 0, 0, 0, 0, 0, 0, 0, 0, 259, LUI.EASING.outQuadratic )
				end
			}
		} )
		...
		self._sequences.MovedLeft = function ()
			Image:AnimateSequence( "MovedLeft" )
		end
		
	end
	
	self._animationSets.DefaultAnimationSet()
	self:addEventHandler( "grid_focus_left_blocked", function ( f34_arg0, f34_arg1 )
		local f34_local0 = f34_arg1.controller or f5_local1
		ACTIONS.AnimateSequence( self, "Blocked" )
	end )
	self:addEventHandler( "grid_focus_left_not_blocked", function ( f35_arg0, f35_arg1 )
		local f35_local0 = f35_arg1.controller or f5_local1
		ACTIONS.AnimateSequence( self, "NotBlocked" )
	end )
	self:addEventHandler( "arrow_button_left_moved", function ( f36_arg0, f36_arg1 )
		local f36_local0 = f36_arg1.controller or f5_local1
		ACTIONS.AnimateSequence( self, "MovedLeft" )
	end )
	self:addEventHandler( "arrow_button_left_blocked", function ( f37_arg0, f37_arg1 )
		local f37_local0 = f37_arg1.controller or f5_local1
		ACTIONS.AnimateSequence( self, "Blocked" )
	end )
	self:addEventHandler( "arrow_button_left_not_blocked", function ( f38_arg0, f38_arg1 )
		local f38_local0 = f38_arg1.controller or f5_local1
		ACTIONS.AnimateSequence( self, "NotBlockedStatic" )
	end )
	self:addEventHandler( "grid_focus_left_moved", function ( f39_arg0, f39_arg1 )
