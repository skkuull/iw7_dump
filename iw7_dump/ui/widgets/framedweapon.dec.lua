...
function FramedWeapon( menu, controller )
	...
	if Engine.IsMultiplayer() and not Engine.IsAliensMode() then
		f15_local6 = MenuBuilder.BuildRegisteredType( "FramedAttachments", {
			controllerIndex = f15_local1
		} )
		f15_local6.id = "AttachmentsTwo"
		f15_local6.SlotOne.OpticsIcon:SetAlpha( 0, 0 )
		f15_local6:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 301, _1080p * 596, _1080p * 116, _1080p * 206 )
		self:addElement( f15_local6 )
		self.AttachmentsTwo = f15_local6
	end
	local f15_local7 = nil
	if Engine.InFrontend() then
		f15_local7 = MenuBuilder.BuildRegisteredType( "GenericListButtonBackground", {
			controllerIndex = f15_local1
		} )
		f15_local7.id = "Background"
		f15_local7.DropShadow:SetAlpha( 0, 0 )
		f15_local7:SetAnchorsAndPosition( 0, 0, 0, 1, 0, 0, 0, _1080p * 24 )
		self:addElement( f15_local7 )
		self.Background = f15_local7
	end
	...
	FrameLabel:setText( ToUpperCase( Engine.Localize( "MPUI_PRIMARY_WEAPON_CAPS" ) ), 0 )
	...
	FrameLabel:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 10, _1080p * -13, _1080p * 2.5, _1080p * 21.5 )
...
MenuBuilder.registerType( "FramedWeapon", FramedWeapon )
LockTable( _M )
