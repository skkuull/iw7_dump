...
function Reticle08( menu, controller )
	...
	ImageS:SetScale( 0.02, 0 )
	ImageS:setImage( RegisterMaterial( "hud_reticle_8" ), 0 )
	ImageS:SetUseAA( true )
	ImageS:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -45, _1080p * 45, _1080p * -45, _1080p * 45 )
	...
	Image:setImage( RegisterMaterial( "hud_reticle_8" ), 0 )
	Image:SetUseAA( true )
	...
	DotBase.id = "DotBase"
	DotBase.DotShadow:SetRGBFromInt( 799526, 0 )
	DotBase.DotShadow:SetAlpha( 1, 0 )
	DotBase.Dot:SetRGBFromInt( 3132568, 0 )
	DotBase.DotHighlight:SetRGBFromInt( 14679807, 0 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ImageS:RegisterAnimationSequence( "ADSIN", {
			...
			{
				function ()
					return self.ImageS:SetScale( 0.03, 60 )
				end
			}
		} )
