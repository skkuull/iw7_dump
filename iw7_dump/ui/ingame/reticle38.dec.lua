...
function Reticle38( menu, controller )
	...
	ImageS.id = "ImageS"
	ImageS:SetRGBFromTable( SWATCHES.Reticles.Red, 0 )
	ImageS:SetAlpha( 0.4, 0 )
	ImageS:setImage( RegisterMaterial( "hud_reticle_38" ), 0 )
	ImageS:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -53, _1080p * 53, _1080p * -53, _1080p * 53 )
	...
	Image.id = "Image"
	Image:SetRGBFromTable( SWATCHES.Reticles.Red, 0 )
	Image:SetAlpha( 0.6, 0 )
	Image:setImage( RegisterMaterial( "hud_reticle_38" ), 0 )
	Image:SetBlendMode( BLEND_MODE.addWithAlpha )
	Image:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -53, _1080p * 53, _1080p * -53, _1080p * 53 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ImageS:RegisterAnimationSequence( "ADSIN", {
			{
				function ()
					return self.ImageS:SetAlpha( 0.15, 60 )
				end
			},
			{
				function ()
...
MenuBuilder.registerType( "Reticle38", Reticle38 )
LockTable( _M )
