...
function ReticleProteus( menu, controller )
	...
	Radial2.id = "Radial2"
	Radial2:SetRGBFromTable( SWATCHES.Reticles.DarkContrast, 0 )
	...
	Radial.id = "Radial"
	Radial:SetRGBFromTable( SWATCHES.Reticles.DarkContrast, 0 )
...
MenuBuilder.registerType( "ReticleProteus", ReticleProteus )
LockTable( _M )
