...
function Reticle41( menu, controller )
	...
	FlakeS.id = "FlakeS"
	FlakeS:SetRGBFromInt( 9494495, 0 )
	FlakeS:SetAlpha( 0.4, 0 )
	FlakeS:SetScale( -0.28, 0 )
	FlakeS:setImage( RegisterMaterial( "hud_reticle_41" ), 0 )
	FlakeS:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -32, _1080p * 32, _1080p * -32, _1080p * 32 )
	...
	Flake:setImage( RegisterMaterial( "hud_reticle_41" ), 0 )
	Flake:SetBlendMode( BLEND_MODE.addWithAlpha )
	Flake:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -32, _1080p * 32, _1080p * -32, _1080p * 32 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		FlakeS:RegisterAnimationSequence( "ADSIN", {
			{
				function ()
					return self.FlakeS:SetAlpha( 0.6, 60 )
				end
			},
			{
				function ()
...
MenuBuilder.registerType( "Reticle41", Reticle41 )
LockTable( _M )
