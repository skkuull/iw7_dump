...
function Reticle39( menu, controller )
	...
	ImageS:setImage( RegisterMaterial( "hud_reticle_39" ), 0 )
	...
	Image:setImage( RegisterMaterial( "hud_reticle_39" ), 0 )
...
MenuBuilder.registerType( "Reticle39", Reticle39 )
LockTable( _M )
