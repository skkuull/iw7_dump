...
function Reticle10( menu, controller )
	...
	ImageS:SetScale( -0.2, 0 )
	ImageS:setImage( RegisterMaterial( "hud_reticle_10" ), 0 )
	ImageS:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -80, _1080p * 80, _1080p * -80, _1080p * 80 )
	...
	Image:setImage( RegisterMaterial( "hud_reticle_10" ), 0 )
	Image:SetBlendMode( BLEND_MODE.addWithAlpha )
	Image:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -80, _1080p * 80, _1080p * -80, _1080p * 80 )
	...
	DotBase.DotHighlight:SetAlpha( 1, 0 )
	DotBase:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -3, _1080p * 3, _1080p * -3, _1080p * 3 )
	DotBase:BindAlphaToModel( DataSources.inGame.player.currentWeapon.adsPercent:GetModel( f3_local1 ) )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ImageS:RegisterAnimationSequence( "ADSOUT", {
			...
			{
				function ()
					return self.ImageS:SetScale( -0.2, 60 )
				end
			}
		} )
		Image:RegisterAnimationSequence( "ADSOUT", {
			...
			{
				function ()
					return self.Image:SetScale( -0.2, 60 )
				end
			}
		} )
