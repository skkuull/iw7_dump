...
function Reticle32( menu, controller )
	...
	ImageS:setImage( RegisterMaterial( "hud_reticle_32" ), 0 )
	...
	Image.id = "Image"
	Image:SetRGBFromTable( SWATCHES.Reticles.LightRed, 0 )
	Image:SetAlpha( 0.6, 0 )
	Image:setImage( RegisterMaterial( "hud_reticle_32" ), 0 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ImageS:RegisterAnimationSequence( "ADSIN", {
			{
				function ()
					return self.ImageS:SetAlpha( 0.4, 0 )
				end
			}
		} )
		Image:RegisterAnimationSequence( "ADSIN", {
			{
				function ()
					return self.Image:SetAlpha( 0.6, 0 )
				end
			}
		} )
...
MenuBuilder.registerType( "Reticle32", Reticle32 )
LockTable( _M )
