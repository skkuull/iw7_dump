...
function ReticleCrosshairEloYellow( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 50 * _1080p, 0, 50 * _1080p )
	self.id = "ReticleCrosshairEloYellow"
	self._animationSets = {}
	self._sequences = {}
	...
	ReticleCrosshair:SetRGBFromTable( SWATCHES.Reticles.Yellow, 0 )
...
MenuBuilder.registerType( "ReticleCrosshairEloYellow", ReticleCrosshairEloYellow )
LockTable( _M )
