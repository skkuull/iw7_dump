...
function GenericTextBox( menu, controller )
	...
	Text:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -50, _1080p * 50, _1080p * -6, _1080p * 6 )
...
MenuBuilder.registerType( "GenericTextBox", GenericTextBox )
LockTable( _M )
