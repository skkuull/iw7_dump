...
function MenuLeftArrow( menu, controller )
	...
	self:addEventHandler( "grid_focus_left_blocked", function ( f22_arg0, f22_arg1 )
		local f22_local0 = f22_arg1.controller or f1_local1
		ACTIONS.AnimateSequence( self, "Blocked" )
	end )
	self:addEventHandler( "grid_focus_left_not_blocked", function ( f23_arg0, f23_arg1 )
		local f23_local0 = f23_arg1.controller or f1_local1
		ACTIONS.AnimateSequence( self, "NotBlocked" )
	end )
	self:addEventHandler( "arrow_button_left_moved", function ( f24_arg0, f24_arg1 )
		local f24_local0 = f24_arg1.controller or f1_local1
		ACTIONS.AnimateSequence( self, "MovedLeft" )
	end )
	self:addEventHandler( "arrow_button_left_blocked", function ( f25_arg0, f25_arg1 )
		local f25_local0 = f25_arg1.controller or f1_local1
		ACTIONS.AnimateSequence( self, "Blocked" )
	end )
	self:addEventHandler( "arrow_button_left_not_blocked", function ( f26_arg0, f26_arg1 )
