...
function HorizontalMinimalScrollbar( menu, controller )
	...
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 400 * _1080p, 0, 16 * _1080p )
	...
	guide:SetAnchorsAndPosition( 0, 0, 0.5, 0.5, 0, 0, _1080p * -1.5, _1080p * 1.5 )
	...
	sliderArea:SetAnchorsAndPosition( 0, 0, 0, 0, _1080p * 4, _1080p * -4, 0, 0 )
