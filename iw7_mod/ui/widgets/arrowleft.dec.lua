...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	f1_arg0:addEventHandler( "grid_focus_left_blocked", function ( f2_arg0, f2_arg1 )
		ACTIONS.AnimateSequence( f1_arg0, "Blocked" )
		f1_arg0:SetFocusable( false )
	end )
	f1_arg0:addEventHandler( "grid_focus_left_not_blocked", function ( f3_arg0, f3_arg1 )
		ACTIONS.AnimateSequence( f1_arg0, "NotBlocked" )
		f1_arg0:SetFocusable( true )
	end )
end

function ArrowLeft( menu, controller )
	...
	self:addEventHandler( "grid_focus_left_moved", function ( f24_arg0, f24_arg1 )
