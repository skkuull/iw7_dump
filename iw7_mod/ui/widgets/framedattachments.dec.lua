...
function FramedAttachments( menu, controller )
	local self = LUI.UIHorizontalNavigator.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 289 * _1080p, 0, 90 * _1080p )
	self.id = "FramedAttachments"
	...
	SlotOne.id = "SlotOne"
	SlotOne:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 95, 0, _1080p * 90 )
	...
	SlotTwo:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 97, _1080p * 192, 0, _1080p * 90 )
	...
	SlotThree:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 194, _1080p * 289, 0, _1080p * 90 )
...
MenuBuilder.registerType( "FramedAttachments", FramedAttachments )
LockTable( _M )
