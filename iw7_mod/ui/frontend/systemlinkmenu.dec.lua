...
local f0_local5 = function ( f6_arg0, f6_arg1 )
	f6_arg0.SystemLinkMenuButtons.JoinGameButton:addEventHandler( "button_action", function ( f7_arg0, f7_arg1 )
		if Engine.IsAliensMode() then
			f6_arg0.ServerBrowser:AnimateSequence( "DisplayServerBrowser" )
		...
		local f7_local1 = f7_local0:GetValue( f6_arg1 )
		if f7_local1 ~= nil and f7_local1 ~= 0 then
			Cac.ValidateAllPlayersPrivateSquadMembers()
			Engine.SetDvarBool( "systemlink_host", false )
			if Engine.IsConsoleGame() then
				local f7_local2 = LUI.FlowManager.GetScopedData( f6_arg0 )
				f7_local2.serverBrowserFocused = true
				ACTIONS.LoseFocus( f6_arg0.SystemLinkMenuButtons, "JoinGameButton", f6_arg1 )
				ACTIONS.GainFocus( f6_arg0, "ServerBrowser", f6_arg1 )
			else
				DebugPrint( "Menu Unsupported on PC at the moment..." )
			end
		end
	end )
	f6_arg0.SystemLinkMenuButtons.CreateGameButton:addEventHandler( "button_action", function ( f8_arg0, f8_arg1 )
		Cac.ValidateAllPlayersPrivateSquadMembers()
		Engine.SetDvarBool( "systemlink_host", true )
		Engine.OnLANCreateGame()
		LUI.FlowManager.RequestAddMenu( Engine.IsAliensMode() and "CPSystemLinkLobby" or "MPSystemLinkLobby", false, f6_arg1, false, {} )
	end )
end
...
f0_local6 = function ( f9_arg0, f9_arg1 )
	...
	f9_local0.onComplete = function ()
		return f0_local6( f9_arg0, f9_arg1 )
	end
	
	Lobby.UpdateServerDisplayList( f9_arg1 )
	Lobby.CreateServersDataModels( f9_arg1 )
end

local f0_local7 = function ( f11_arg0, f11_arg1, f11_arg2 )
	assert( f11_arg0.SystemLinkMenuButtons.JoinGameButton )
	assert( f11_arg0.SystemLinkMenuButtons.CreateGameButton )
	f11_arg0.isSignInMenu = true
	f0_local5( f11_arg0, f11_arg1 )
	local f11_local0 = Engine.IsAliensMode()
	if f11_local0 then
		Engine.SetFrontEndSceneSection( "zm_main", 1 )
	end
	if not f11_local0 then
		f11_arg0.MenuTitle.MenuBreadcrumbs:setText( ToUpperCase( Engine.Localize( "LUA_MENU_BREADCRUMB_2_ITEMS", "EXE_LOCAL_PLAY", "MENU_MULTIPLAYER" ) ), 0 )
...
MenuBuilder.registerType( "SystemLinkMenu", function ( menu, controller )
	...
	if CONDITIONS.IsCoreMultiplayer( self ) then
		...
		f22_local5.MenuTitle:setText( ToUpperCase( Engine.Localize( "PLATFORM_SYSTEM_LINK_TITLE" ) ), 0 )
