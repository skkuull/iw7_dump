...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	assert( f1_arg0.LethalStatsRows )
	local f1_local0 = Cac.GetLethalStats( f1_arg1 )
	f1_arg0.LethalStatsRows:SetRefreshChild( function ( f2_arg0, f2_arg1, f2_arg2 )
		f2_arg0:SetupLethalRowData( f1_local0[f2_arg2 + 1] )
	end )
	f1_arg0.LethalStatsRows:SetNumRows( #f1_local0 )
	f1_arg0.LethalStatsRows:RefreshContent()
...
function CombatRecordLethals( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920 * _1080p, 0, 1080 * _1080p )
	self.id = "CombatRecordLethals"
	self._animationSets = {}
	self._sequences = {}
	...
	local LethalStatsRows = nil
	
	LethalStatsRows = LUI.UIGrid.new( nil, {
		maxVisibleColumns = 1,
		maxVisibleRows = 10,
	...
	LethalStatsRows.id = "LethalStatsRows"
	LethalStatsRows:setUseStencil( true )
	LethalStatsRows:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 96, _1080p * 796, _1080p * 239, _1080p * 647 )
	self:addElement( LethalStatsRows )
	self.LethalStatsRows = LethalStatsRows
	...
	MenuTitle.MenuTitle:setText( ToUpperCase( Engine.Localize( "CHALLENGE_SUBCATEGORY_LETHAL" ) ), 0 )
	MenuTitle.MenuBreadcrumbs:setText( ToUpperCase( "" ), 0 )
	MenuTitle.Icon:SetTop( _1080p * -28.5, 0 )
	MenuTitle.Icon:SetBottom( _1080p * 61.5, 0 )
	MenuTitle:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 96, _1080p * 1044, _1080p * 54, _1080p * 134 )
	...
	LethalStatsRows:AddScrollbar( f4_local22( bindButton ) )
	LethalStatsRows:AddArrow( ArrowUp )
	LethalStatsRows:AddArrow( ArrowDown )
	LethalStatsRows:AddItemNumbers( ListCount )
...
MenuBuilder.registerType( "CombatRecordLethals", CombatRecordLethals )
LockTable( _M )
