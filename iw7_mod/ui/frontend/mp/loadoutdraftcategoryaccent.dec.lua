...
function LoadoutDraftCategoryAccent( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 20 * _1080p, 0, 100 * _1080p )
	self.id = "LoadoutDraftCategoryAccent"
	...
	Border:SetAnchorsAndPosition( 0, 0, 0, 0, 0, _1080p * -12, 0, 0 )
	...
	Block:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -8, 0, 0, _1080p * 26 )
...
MenuBuilder.registerType( "LoadoutDraftCategoryAccent", LoadoutDraftCategoryAccent )
LockTable( _M )
