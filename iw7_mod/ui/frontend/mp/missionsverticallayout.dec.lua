...
function MissionsVerticalLayout( menu, controller )
	...
	MissionSelect.buttonDescription = Engine.Localize( "PLATFORM_DESC_FIND_GAME" )
	MissionSelect.Text:setText( ToUpperCase( Engine.Localize( "MENU_PLAYERMATCH_PLAYLISTS" ) ), 0 )
	...
	MissionSelect:addEventHandler( "button_action", function ( f11_arg0, f11_arg1 )
		...
		ACTIONS.PlayMission( self, f11_local0 )
	end )
...
MenuBuilder.registerType( "MissionsVerticalLayout", MissionsVerticalLayout )
LockTable( _M )
