...
function ContractsButtonCP( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 340 * _1080p, 0, 60 * _1080p )
	self.id = "ContractsButtonCP"
	self._animationSets = {}
	self._sequences = {}
	...
	self.buttonDescription = Engine.Localize( "ZM_CONTRACTS_MENU_BUTTON_DESC" )
	...
	CompletedCount:SetAnchorsAndPosition( 0, 0, 1, 0, _1080p * 122.5, _1080p * -42.5, _1080p * -26, _1080p * -4 )
	self:addElement( CompletedCount )
	self.CompletedCount = CompletedCount
	
	local Contracts = nil
	
	Contracts = MenuBuilder.BuildRegisteredType( "MenuButton", {
		controllerIndex = f4_local1
	} )
	Contracts.id = "Contracts"
	Contracts.buttonDescription = Engine.Localize( "LUA_MENU_ZM_BOUNTIES_DESC" )
	Contracts.Text:setText( ToUpperCase( Engine.Localize( "LUA_MENU_ZM_BOUNTIES" ) ), 0 )
	...
	Border:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * -30, 0 )
	...
	NewItemNotification:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -74, _1080p * -10, _1080p * -17, _1080p * 47 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		NewItemNotification:RegisterAnimationSequence( "Arabic", {
			{
				function ()
					return self.NewItemNotification:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * -64, 0, _1080p * -17, _1080p * 47, 0 )
				end
			}
		} )
		...
		Border:RegisterAnimationSequence( "ButtonOver", {
			{
				function ()
					return self.Border:SetRGBFromTable( SWATCHES.Zombies.menuHeader, 0 )
				end
			}
		} )
		...
		Border:RegisterAnimationSequence( "ButtonUp", {
			...
			{
				function ()
					return self.Border:SetAnchorsAndPosition( 0, 0, 1, 0, 0, _1080p * -37, _1080p * -30, 0, 0 )
				end
			}
		} )
	...
	self:addEventHandler( "button_action", function ( f18_arg0, f18_arg1 )
		ACTIONS.OpenMenu( "ContractMenu", true, f18_arg1.controller or f4_local1 )
	end )
	self:addEventHandler( "button_over", function ( f19_arg0, f19_arg1 )
		local f19_local0 = f19_arg1.controller or f4_local1
...
MenuBuilder.registerType( "ContractsButtonCP", ContractsButtonCP )
LockTable( _M )
