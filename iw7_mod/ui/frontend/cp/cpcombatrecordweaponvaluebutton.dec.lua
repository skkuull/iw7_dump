...
function CPCombatRecordWeaponValueButton( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 560 * _1080p, 0, 30 * _1080p )
	self.id = "CPCombatRecordWeaponValueButton"
	...
	GenericDualLabelButton:SubscribeToModelThroughElement( self, "kills", function ()
		local f3_local0 = self:GetDataSource()
		f3_local0 = f3_local0.kills:GetValue( f1_local1 )
...
MenuBuilder.registerType( "CPCombatRecordWeaponValueButton", CPCombatRecordWeaponValueButton )
LockTable( _M )
