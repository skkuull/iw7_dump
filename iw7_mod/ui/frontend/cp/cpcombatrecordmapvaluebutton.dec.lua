...
function CPCombatRecordMapValueButton( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 600 * _1080p, 0, 30 * _1080p )
	self.id = "CPCombatRecordMapValueButton"
	...
	GenericDualLabelButton:SubscribeToModelThroughElement( self, "rounds", function ()
		local f3_local0 = self:GetDataSource()
		f3_local0 = f3_local0.rounds:GetValue( f1_local1 )
...
MenuBuilder.registerType( "CPCombatRecordMapValueButton", CPCombatRecordMapValueButton )
LockTable( _M )
