...
function GaussPhaseChargeMeter( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 16 * _1080p, 0, 16 * _1080p )
	self.id = "GaussPhaseChargeMeter"
	self._animationSets = {}
	self._sequences = {}
	...
	ChargeMeterScopeCopy0:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * -154, _1080p * -145, _1080p * -47, _1080p * 53 )
	...
	ChargeMeterScopeCopy1:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * 145, _1080p * 154, _1080p * -47, _1080p * 53 )
...
MenuBuilder.registerType( "GaussPhaseChargeMeter", GaussPhaseChargeMeter )
LockTable( _M )
