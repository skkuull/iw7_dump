...
function Reticle31( menu, controller )
	...
	ImageS.id = "ImageS"
	ImageS:SetRGBFromTable( SWATCHES.Reticles.Blue, 0 )
	ImageS:SetAlpha( 0.4, 0 )
	ImageS:setImage( RegisterMaterial( "hud_reticle_31" ), 0 )
	...
	Image.id = "Image"
	Image:SetRGBFromTable( SWATCHES.Reticles.LightCyan, 0 )
	Image:SetAlpha( 0.6, 0 )
	Image:setImage( RegisterMaterial( "hud_reticle_31" ), 0 )
