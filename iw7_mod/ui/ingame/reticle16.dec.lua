...
function Reticle16( menu, controller )
	...
	ImageS.id = "ImageS"
	ImageS:SetRGBFromInt( 16741744, 0 )
	ImageS:SetAlpha( 0.4, 0 )
	ImageS:setImage( RegisterMaterial( "hud_reticle_16" ), 0 )
	ImageS:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -36, _1080p * 36, _1080p * -36, _1080p * 36 )
	...
	Image:setImage( RegisterMaterial( "hud_reticle_16" ), 0 )
	Image:SetBlendMode( BLEND_MODE.addWithAlpha )
	Image:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -36, _1080p * 36, _1080p * -36, _1080p * 36 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ImageS:RegisterAnimationSequence( "ADSOUT", {
			{
				function ()
					return self.ImageS:SetScale( -0.45, 60 )
				end
			},
			{
				function ()
		...
		Image:RegisterAnimationSequence( "ADSOUT", {
			{
				...
				function ()
					return self.Image:SetAlpha( 0.3, 60 )
				end
			},
			{
				function ()
					return self.Image:SetScale( -0.45, 60 )
				end
			}
		} )
...
MenuBuilder.registerType( "Reticle16", Reticle16 )
LockTable( _M )
